...
export function Header({ userEmail, onMenuToggle }: HeaderProps) {
  ...
  return (
    <header className="bg-gradient-to-r from-slate-50 via-white to-blue-50 border-b border-gray-200 px-4 py-3 flex items-center justify-between sticky top-0 z-40 shadow-sm">
